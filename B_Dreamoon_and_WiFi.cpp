...
void solve()
{
    string s, t;
    cin >> s >> t;
    ll pos1 = 0, pos2 = 0, min1 = 0, min2 = 0, qmark = 0;
    ...
    ll pos = (pos1 - pos2), min = (min1 - min2);

    if (pos+min==qmark&&pos>=0&&min>=0)
    {
        double ans = C(qmark, pos) / pow(2, qmark);
        cout << fixed << setprecision(12) << ans << ln;
    }
    else{
        cout << "0.000000000000" << ln;
    }
}
int main()
{
